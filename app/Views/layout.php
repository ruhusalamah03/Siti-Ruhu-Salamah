...
<body>
  ...
  <section id="hero" class="d-flex flex-column align-items-center justify-content-center">
    <h1>Halo saya Siti Ruhu Salamah</h1>
    <h2>Mahasiswa Teknik Informatika semester 6</h2>
    ...
    <div class="container d-flex align-items-center justify-content-between">
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li><a class="nav-link scrollto" href="#resume">Riwayat Hidup</a></li>
          <li><a class="nav-link scrollto" href="#services">Koleksi</a></li>
          <li><a class="nav-link scrollto" href="#portfolio">Dokumentasi</a></li>
          <li class="dropdown"><a href="#"><span>Drop Down</span> <i class="bi bi-chevron-down"></i></a>
            <ul>
              <li><a href="#">Drop D own 1</a></li>
